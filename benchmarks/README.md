...
- `bench_robotics.py` compares NumPy and compiled paths for batched robot kinematics, transform composition and pose interpolation, clearance summaries and detailed collision reports, broad-phase collision checks, trajectory peaks, retiming, IK, velocity mapping, and bounded planning workers
