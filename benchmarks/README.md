...
- `bench_robotics.py` compares NumPy and compiled paths for batched robot kinematics, transform composition and pose interpolation, clearance, broad-phase collision checks, retiming, IK, and velocity mapping
