...
cpp_exts = [
    ...
    Extension(
        "mastermlx.robotics._kinematics_cpp",
        ["mastermlx/robotics/_kinematics_cpp.cpp"],
        include_dirs=inc_dirs,
        extra_compile_args=["-O3", *thread_flags],
        extra_link_args=thread_flags,
        language="c++",
    ...
    Extension(
        "mastermlx.robotics._dynamics_cpp",
        ["mastermlx/robotics/_dynamics_cpp.cpp"],
        include_dirs=inc_dirs,
        extra_compile_args=["-O3", *thread_flags],
        extra_link_args=thread_flags,
        language="c++",
    ...
    Extension(
        "mastermlx.robotics._collision_cpp",
        ["mastermlx/robotics/_collision_cpp.cpp"],
        include_dirs=inc_dirs,
        extra_compile_args=["-O3", *thread_flags],
        extra_link_args=thread_flags,
        language="c++",
    ...
    Extension(
        "mastermlx.robotics._retiming_cpp",
        ["mastermlx/robotics/_retiming_cpp.cpp"],
        include_dirs=inc_dirs,
        extra_compile_args=["-O3"],
        language="c++",
    ),
    ...
    Extension(
        "mastermlx.robotics._transforms_cpp",
        ["mastermlx/robotics/_transforms_cpp.cpp"],
        include_dirs=inc_dirs,
        extra_compile_args=["-O3"],
        language="c++",
    ),
    Extension(
        "mastermlx.robotics._spatial_cpp",
        ["mastermlx/robotics/_spatial_cpp.cpp"],
        include_dirs=inc_dirs,
        extra_compile_args=["-O3", *thread_flags],
        extra_link_args=thread_flags,
        language="c++",
